                        ...
                        <div class="kt-widget14">
                            <div class="kt-widget14__header">
                                <h3 class="kt-widget14__title">
                                    Biểu đồ thể hiện năng lực
                                </h3>
                                <span class="kt-widget14__desc">
                                    Thể hiện thiên hướng cá nhân với các loại hình trí thông minh
                                </span>
                            </div>
                            <div class="kt-widget14__content">
                                ...
                                <div class="kt-widget14__legends">
                                    <div class="kt-widget14__legend">
                                        ...
                                        <span class="kt-widget14__stats">37% Âm nhạc</span>
                                    </div>
                                    <div class="kt-widget14__legend">
                                        <span class="kt-widget14__bullet kt-bg-warning"></span>
                                        <span class="kt-widget14__stats">47% Thể thao</span>
                                    </div>
                                    <div class="kt-widget14__legend">
                                        <span class="kt-widget14__bullet kt-bg-brand"></span>
                                        <span class="kt-widget14__stats">19% Tóan học</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
                            <div class="kt-timeline-v2__item">
                                ...
                                <div class="kt-timeline-v2__item-text  kt-padding-top-5">
                                    Đạt <a href="#" class="kt-link kt-link--brand kt-font-bolder">9 điểm</a> môn Toán.
                                </div>
                            </div>
                            <div class="kt-timeline-v2__item">
                                ...
                                <div class="kt-timeline-v2__item-text kt-timeline-v2__item-text--bold">
                                    Họp nhóm cùng với 4 thành viên
                                </div>
                            ...
                            <div class="kt-timeline-v2__item">
                                ...
                                <div class="kt-timeline-v2__item-text kt-padding-top-5">
                                    Đạt <a href="#" class="kt-link kt-link--brand kt-font-bolder">9.5</a> điểm Tiếng Anh.
                                </div>
                            </div>
                            <div class="kt-timeline-v2__item">
                                ...
                                <div class="kt-timeline-v2__item-text kt-padding-top-5">
                                    Bạn đã thêm một <a href="#" class="kt-link kt-link--brand kt-font-bolder">một mục tiêu mới</a>.
                                </div>
                            </div>
                            <div class="kt-timeline-v2__item">
                                ...
                                <div class="kt-timeline-v2__item-text kt-padding-top-5">
                                    Điểm hoạt động tăng <a href="#" class="kt-link kt-link--brand kt-font-bolder">10</a>.
                                </div>
                            </div>
                            <div class="kt-timeline-v2__item">
                                <span class="kt-timeline-v2__item-time">16:00</span>
                                ...
                                <div class="kt-timeline-v2__item-text kt-padding-top-5">
                                    Bạn đã chỉnh sửa <a href="#" class="kt-link kt-link--brand kt-font-bolder">một mục tiêu mới</a>.
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="kt-widget5">
                                <div class="kt-widget5__item">
                                    <div class="kt-widget5__content">
                                        ...
                                        <div class="kt-widget5__section">
                                            <a href="#" class="kt-widget5__title">
                                                Toán lớp 10 đại số cơ bản
                                            </a>
                                            <p class="kt-widget5__desc">
                                                Kiến thức toán đại số lớp 10 cơ bản
                                            </p>
                                            <div class="kt-widget5__info">
                                                <span>Author:</span>
                                                <span class="kt-font-info">Nguyễn Văn A</span>
                                                <span>Released:</span>
                                    ...
                                    <div class="kt-widget5__content">
                                        <div class="kt-widget5__stats">
                                            ...
                                            <span class="kt-widget5__sales">1/Buổi</span>
                                        </div>
                                        <div class="kt-widget5__stats">
                                ...
                                <div class="kt-widget5__item">
                                    <div class="kt-widget5__content">
                                        ...
                                        <div class="kt-widget5__section">
                                            <a href="#" class="kt-widget5__title">
                                                Tóan lớp 10 hình học cơ bản
                                            </a>
                                            <p class="kt-widget5__desc">
                                                Kiến thức toán hình học lớp 10 cơ bản
                                            </p>
                                            <div class="kt-widget5__info">
                                                <span>Author:</span>
                                                <span class="kt-font-info">Nguyễn Thị A</span>
                                                <span>Released:</span>
                                                <span class="kt-font-info">23.08.17</span>
                                            </div>
                                        </div>
                        ...
                        <div class="tab-pane active" id="kt_widget4_tab1_content">
                            <div class="kt-widget4">
                                <div class="kt-widget4__item">
                                    ...
                                    <a href="#" class="btn btn-sm btn-label-brand btn-bold">Theo dõi</a>
                                </div>
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__pic kt-widget4__pic--pic">
                                    ...
                                    <a href="#" class="btn btn-sm btn-label-warning btn-bold">Theo dõi</a>
                                </div>
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__pic kt-widget4__pic--pic">
                                    ...
                                    <a href="#" class="btn btn-sm btn-label-danger btn-bold">Theo dõi</a>
                                </div>
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__pic kt-widget4__pic--pic">
                                    ...
                                    <a href="#" class="btn btn-sm btn-label-success btn-bold">Theo dõi</a>
                                </div>
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__pic kt-widget4__pic--pic">
                                    ...
                                    <a href="#" class="btn btn-sm btn-label-primary btn-bold">Theo dõi</a>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="kt_widget4_tab2_content">
                            <div class="kt-widget4">
                                <div class="kt-widget4__item">
                                    ...
                                    <a href="#" class="btn btn-sm btn-label-success">Theo dõi</a>
                                </div>
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__pic kt-widget4__pic--pic">
                                    ...
                                    <a href="#" class="btn btn-sm btn-label-brand">Theo dõi</a>
                                </div>
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__pic kt-widget4__pic--pic">
                                    ...
                                    <a href="#" class="btn btn-sm btn-label-danger">Theo dõi</a>
                                </div>
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__pic kt-widget4__pic--pic">
                                        <img src="assets/media/users/100_2.jpg" alt="">
                                ...
                                <div class="kt-widget4__item">
                                    ...
                                    <a href="#" class="btn btn-sm btn-label-info">Theo dõi</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-8">
                    <div class="kt-portlet kt-portlet--height-fluid kt-portlet--mobile ">
                        ...
                        <div class="kt-portlet__body kt-portlet__body--fit">
                            ...
                            <!--begin: Datatable -->
                            <div class="kt-datatable kt-datatable--default kt-datatable--error kt-datatable--loaded" id="kt_datatable_latest_orders">
                                <table class="kt-datatable__table" style="display: block; min-height: 300px; max-height: 400px;">
                                    <thead class="kt-datatable__head">
                                        <tr class="kt-datatable__row">
                                            <th data-field="RecordID" class="kt-datatable__cell--center kt-datatable__cell">
                                                <span style="width: 110px;">Tháng</span>
                                            </th>
                                            <th data-field="ShipName" data-autohide-disabled="false" class="kt-datatable__cell">
                                                <span style="width: 110px;">Toán</span>
                                            </th>
                                            <th data-field="ShipDate" class="kt-datatable__cell">
                                                <span style="width: 110px;">Văn</span>
                                            </th>
                                            <th data-field="Status" class="kt-datatable__cell">
                                                <span style="width: 110px;">Lý</span>
                                            </th>
                                            <th data-field="Type" class="kt-datatable__cell">
                                                <span style="width: 110px;">Tiếng Anh</span>
                                            </th>
                                            <th data-field="Actions" data-autohide-disabled="false" class="kt-datatable__cell">
                                                <span style="width: 110px;">Sinh Học</span>
                                            </th>
                                        </tr>
                                    </thead>
                                    @for ($i = 1; $i < 10; $i++)
                                    <thead class="kt-datatable__head">
                                        <tr class="kt-datatable__row">
                                            <th data-field="RecordID" class="kt-datatable__cell--center kt-datatable__cell">
                                                <span style="width: 110px;">{{ $i }}</span>
                                            </th>
                                            <th data-field="ShipName" data-autohide-disabled="false" class="kt-datatable__cell">
                                                <span style="width: 110px;">{{ rand(6,10) }}</span>
                                            </th>
                                            <th data-field="ShipDate" class="kt-datatable__cell">
                                                <span style="width: 110px;">{{ rand(6,10) }}</span>
                                            </th>
